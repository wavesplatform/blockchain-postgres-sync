...
CREATE TABLE IF NOT EXISTS asset_updates (
    block_uid BIGINT NOT NULL REFERENCES blocks_microblocks(uid) ON DELETE RESTRICT,
    uid BIGINT UNIQUE GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE IF NOT EXISTS asset_origins (
    ...
    first_asset_update_uid BIGINT NOT NULL REFERENCES asset_updates(uid) ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS txs (
    ...
    CONSTRAINT fk_blocks_uid FOREIGN KEY (block_uid) REFERENCES blocks_microblocks(uid) ON DELETE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS txs_11_transfers (
    ...
    CONSTRAINT fk_tx_uid FOREIGN KEY (tx_uid) REFERENCES txs_11(uid) ON DELETE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS txs_12_data (
    ...
    PRIMARY KEY (tx_uid, position_in_tx),
    CONSTRAINT fk_tx_uid FOREIGN KEY (tx_uid) REFERENCES txs_12(uid) ON DELETE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS txs_16_args (
    ...
    CONSTRAINT fk_tx_uid FOREIGN KEY (tx_uid) REFERENCES txs_16(uid) ON DELETE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS txs_18_args (
    ...
    PRIMARY KEY (tx_uid, position_in_args),
    CONSTRAINT fk_tx_uid FOREIGN KEY (tx_uid) REFERENCES txs_18(uid) ON DELETE RESTRICT
);
